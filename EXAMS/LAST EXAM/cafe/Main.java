...
//Add Employee
        ...
        Employee employeeStephen = cafe.getEmployee("Sara");  // Employee: Sara, 24 from UK
        System.out.println(oldestEmployee); // Employee: Alexander, 30 from Bulgaria System.out.println(employeeStephen);
